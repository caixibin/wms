			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-inputurl="<s:url action="brand_input"/>"/>
							<input type="button" value="删除所有" class="ui_input_btn01 btn_all" data-deleurl="<s:url action="brand_batchDelete"/>"/>
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							<s:iterator value="#pageResult.data">
								<tr>
									...
									<td>
										<s:a action="brand_input">编辑
											<s:param name="brand.id" value="id"/>
										</s:a>
										<%--<s:a action="brand_delete">删除
											<s:param name="brand.id" value="id"/>
										</s:a>--%>
										<s:url namespace="/" action="brand_delete" var="deleUrl">
											<s:param name="brand.id" value="id"/>
										</s:url>
