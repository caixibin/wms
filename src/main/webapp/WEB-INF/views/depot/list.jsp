			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-inputurl="<s:url action="depot_input"/>"/>
							<input type="button" value="删除所有" class="ui_input_btn01 btn_all" data-deleurl="<s:url action="depot_batchDelete"/>"/>
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							<s:iterator value="#pageResult.data">
								<tr>
									...
									<td>
										<s:a action="depot_input">编辑
											<s:param name="depot.id" value="id"/>
										</s:a>
										<s:url namespace="/" action="depot_delete" var="deleUrl">
											<s:param name="depot.id" value="id"/>
										</s:url>
