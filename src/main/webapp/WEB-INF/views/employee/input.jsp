            ...
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <s:if test="employee.id == null">
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <s:password name="employee.password" class="ui_input_txt02" id="password"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="ui_text_lt">
                            <table>
                                <tr>
                                    <td>
                                        <s:select list="#roles" listKey="id" listValue="name" multiple="true" class="ui_multiselect01 roleAll"/>
                                    </td>
                                    <td align="center">
                                    ...
                                    <td>
                                        <s:select list="employee.roles" name="employee.roles.id" listKey="id" listValue="name"
                                                  multiple="true" class="ui_multiselect01 roleSelected"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
