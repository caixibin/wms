			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
						<input type="button" value="加载权限" class="ui_input_btn01 btn_reload" data-inputurl="<s:url action="permission_reload"/>"/>
							<input type="button" value="删除所有" class="ui_input_btn01 btn_all" data-deleurl="<s:url action="permission_batchDelete"/>"/>
                        </div>
					</div>
				</div>
			</div>
						...
						<tbody>
							<s:iterator value="#pageResult.data">
								<tr>
									...
									<td>
										<s:url namespace="/" action="permission_delete" var="deleUrl">
