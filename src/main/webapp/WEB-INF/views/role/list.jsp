			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-inputurl="<s:url action="role_input"/>"/>
							<input type="button" value="删除所有" class="ui_input_btn01 btn_all" data-deleurl="<s:url action="role_batchDelete"/>"/>
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							<s:iterator value="#pageResult.data">
								<tr>
									...
									<td>
										<s:a action="role_input">编辑
											<s:param name="role.id" value="id"/>
										</s:a>
										<s:url namespace="/" action="role_delete" var="deleUrl">
											<s:param name="role.id" value="id"/>
										</s:url>
