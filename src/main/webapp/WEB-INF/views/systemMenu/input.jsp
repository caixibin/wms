        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:textfield name="parentName" class="ui_input_txt02" readonly="true" style="background-color:pink"/>
                ...
                <%--<tr>
                    ...
                    <td class="ui_text_lt">
                        <table>
                            <tr>
                                <td>
                                    <s:select list="#depts" class="ui_multiselect01" listKey="id" listValue="name" multiple="true" />
                                </td>
                                <td align="center">
                                ...
                                <td>
                                    <s:select list="#depts" name="systemMenu.id" class="ui_multiselect01" listKey="id" listValue="name" multiple="true" />
                                </td>
                            </tr>
                        </table>
                    </td>
